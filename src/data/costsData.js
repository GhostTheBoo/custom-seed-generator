export class AbilityCost {
	constructor(ability, address, cost, zipID, extraData) {
		...
		this.saveToJSON = () => {
			return this.isReplaced() ? JSON.stringify(this, ["costAddress", "zipID", "replacementCost"]) + "," : ""
		}
		...
		this.saveToLua = (isCommented) => {
			// let costAddress = this.costAddress - 0x1CCB300 - 0x29C
			let costAddress = "0x" + this.costAddress.toString(16).toUpperCase().padStart(4, "0")
			let ret = ""
			if (this.isReplaced()) { 
				let cost = "0x" + this.replacementCost.toString(16).toUpperCase().padStart(2, "0")
				ret += "\tWriteByte(BAR(Sys3, 0x2, " + costAddress + "), " + cost + ", OnPC)"
				if (isCommented) ret += " -- " + this.ability + " Cost: " + this.replacementCost
				ret += "\n"
			}
			return [ret, this]
				...
				let newAbilities = abilityType.abilities.map(category => {
					...
					if (foundCategory !== undefined) {
						let newSpecificAbilities = category.specificAbilities.map(specificAbility => {
							let foundSpec = foundCategory.specificAbilities.find(loadSpec => loadSpec.zipId === specificAbility.zipID)
		...
		abilities: [
			{
				...
				specificAbilities:
					[
						new AbilityCost("Fire", 0x0744, 12, 49,
							"  Execute: 2\n" +
							"  Argument: 0\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Magic\n" +
						...
						new AbilityCost("Fira", 0x1344, 12, 119,
							"  Execute: 2\n" +
							"  Argument: 0\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Magic\n" +
						...
						new AbilityCost("Firaga", 0x1374, 12, 120,
							"  Execute: 2\n" +
							"  Argument: 0\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Magic\n" +
			...
			},
			{
				...
				specificAbilities:
					[
						new AbilityCost("Blizzard", 0x07A4, 15, 51,
							"  Execute: 2\n" +
							"  Argument: 1\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Magic\n" +
						...
						new AbilityCost("Blizzara", 0x13A4, 15, 121,
							"  Execute: 2\n" +
							"  Argument: 1\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Magic\n" +
						...
						new AbilityCost("Blizzaga", 0x13D4, 15, 122,
							"  Execute: 2\n" +
							"  Argument: 1\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Magic\n" +
			...
			},
			{
				...
				specificAbilities:
					[
						new AbilityCost("Thunder", 0x0774, 18, 50,
							"  Execute: 2\n" +
							"  Argument: 2\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Magic\n" +
						...
						new AbilityCost("Thundara", 0x1404, 18, 123,
							"  Execute: 2\n" +
							"  Argument: 2\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Magic\n" +
						...
						new AbilityCost("Thundaga", 0x1434, 18, 124,
							"  Execute: 2\n" +
							"  Argument: 2\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Magic\n" +
			...
			},
			{
				...
				specificAbilities:
					[
						new AbilityCost("Cure", 0x07D4, 255, 52,
							"  Execute: 2\n" +
							"  Argument: 3\n" +
							"  SubMenu: 4\n" +
							"  CmdIcon: Magic\n" +
						...
						new AbilityCost("Cura", 0x1464, 255, 125,
							"  Execute: 2\n" +
							"  Argument: 3\n" +
							"  SubMenu: 4\n" +
							"  CmdIcon: Magic\n" +
						...
						new AbilityCost("Curaga", 0x1494, 255, 126,
							"  Execute: 2\n" +
							"  Argument: 3\n" +
							"  SubMenu: 4\n" +
							"  CmdIcon: Magic\n" +
			...
			},
			{
				...
				specificAbilities:
					[
						new AbilityCost("Magnet", 0x1CA4, 30, 174,
							"  Execute: 2\n" +
							"  Argument: 4\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Magic\n" +
						...
						new AbilityCost("Magnera", 0x1CD4, 30, 175,
							"  Execute: 2\n" +
							"  Argument: 4\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Magic\n" +
						...
						new AbilityCost("Magnega", 0x1D04, 30, 176,
							"  Execute: 2\n" +
							"  Argument: 4\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Magic\n" +
			...
			},
			{
				...
				specificAbilities:
					[
						new AbilityCost("Reflect", 0x1D34, 10, 177,
							"  Execute: 2\n" +
							"  Argument: 5\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Magic\n" +
						...
						new AbilityCost("Reflera", 0x1D64, 10, 178,
							"  Execute: 2\n" +
							"  Argument: 5\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Magic\n" +
						...
						new AbilityCost("Reflega", 0x1D94, 10, 179,
							"  Execute: 2\n" +
							"  Argument: 5\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Magic\n" +
		...
		abilities: [
			{
				...
				specificAbilities:
					[
						new AbilityCost("Strike Raid", 0x7BB4, 65, 704,
							"  Execute: 707\n" +
							"  Argument: 704\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Null\n" +
						...
						new AbilityCost("Sonic Blade", 0x7A94, 60, 698,
							"  Execute: 707\n" +
							"  Argument: 698\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Null\n" +
						...
						new AbilityCost("Ragnarok", 0x7974, 80, 683,
							"  Execute: 707\n" +
							"  Argument: 683\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Null\n" +
						...
						new AbilityCost("Ars Arcanum", 0x7B24, 72, 701,
							"  Execute: 707\n" +
							"  Argument: 701\n" +
							"  SubMenu: -1\n" +
							"  CmdIcon: Null\n" +
		...
		abilities: [
			{
				...
				specificAbilities: [
					new AbilityCost("Twin Howl", 0x0B94, 255, 74,
						"  Execute: 81\n" +
						"  Argument: 74\n" +
						"  SubMenu: -1\n" +
						"  CmdIcon: Null\n" +
			...
			},
			{
				...
				specificAbilities: [
					new AbilityCost("Bushido", 0x0D14, 255, 82,
						"  Execute: 81\n" +
						"  Argument: 82\n" +
						"  SubMenu: -1\n" +
						"  CmdIcon: Null\n" +
			...
			},
			{
				...
				specificAbilities: [
					new AbilityCost("Red Rocket", 0x16A4, 255, 139,
						"  Execute: 81\n" +
						"  Argument: 139\n" +
						"  SubMenu: -1\n" +
						"  CmdIcon: Null\n" +
			...
			},
			{
				...
				specificAbilities: [
					new AbilityCost("Speedster", 0x3CE4, 255, 351,
						"  Execute: 81\n" +
						"  Argument: 351\n" +
						"  SubMenu: -1\n" +
						"  CmdIcon: Null\n" +
			...
			},
			{
				...
				specificAbilities: [
					new AbilityCost("Bluff", 0x3E04, 255, 357,
						"  Execute: 81\n" +
						"  Argument: 357\n" +
						"  SubMenu: -1\n" +
						"  CmdIcon: Null\n" +
			...
			},
			{
				...
				specificAbilities: [
					new AbilityCost("Wildcat", 0x4194, 255, 376,
						"  Execute: 81\n" +
						"  Argument: 376\n" +
						"  SubMenu: -1\n" +
						"  CmdIcon: Null\n" +
			...
			},
			{
				...
				specificAbilities: [
					new AbilityCost("Dance Call", 0x4704, 255, 405,
						"  Execute: 81\n" +
						"  Argument: 405\n" +
						"  SubMenu: -1\n" +
						"  CmdIcon: Null\n" +
			...
			},
			{
				...
				specificAbilities: [
					new AbilityCost("Setup", 0x48E4, 255, 415,
						"  Execute: 81\n" +
						"  Argument: 415\n" +
						"  SubMenu: -1\n" +
						"  CmdIcon: Null\n" +
			...
			},
			{
				...
				specificAbilities: [
					new AbilityCost("Session", 0x6534, 255, 569,
						"  Execute: 81\n" +
						"  Argument: 569\n" +
						"  SubMenu: -1\n" +
						"  CmdIcon: Null\n" +
			...
			},
			{
				...
				specificAbilities: [
					new AbilityCost("Trinity Limit", 0x55A4, 255, 620,
						"  Execute: 81\n" +
						"  Argument: 620\n" +
						"  SubMenu: -1\n" +
						"  CmdIcon: Null\n" +
			...
			},
			{
				...
				specificAbilities: [
					new AbilityCost("Whirli-Goof", 0x2B74, 255, 255,
						"  Execute: 81\n" +
						"  Argument: 255\n" +
						"  SubMenu: -1\n" +
						"  CmdIcon: Null\n" +
					...
					new AbilityCost("Knocksmash", 0x3AA4, 255, 338,
						"  Execute: 81\n" +
						"  Argument: 338\n" +
						"  SubMenu: -1\n" +
						"  CmdIcon: Null\n" +
			...
			},
			{
				...
				specificAbilities: [
					new AbilityCost("Comet", 0x3084, 255, 282,
						"  Execute: 81\n" +
						"  Argument: 282\n" +
						"  SubMenu: -1\n" +
						"  CmdIcon: Null\n" +
					...
					new AbilityCost("Duck Flare", 0x3BC4, 255, 344,
						"  Execute: 81\n" +
						"  Argument: 344\n" +
						"  SubMenu: -1\n" +
						"  CmdIcon: Null\n" +
