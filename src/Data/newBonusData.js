...
export const bonusData = [
	{
		...
		bonusFights: [
			...
			new BonusFight('Treasure Room Heartless',
				...
				new BonusReward('Aladdin', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 15, 0, 0, 0, 0, 0)),
		...
		worldBonuses: [
			...
			new BonusFight('Dark Thorn',
				...
				new BonusReward('Beast', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 35, 0, 0, 0, 0, 0)),
			new BonusFight('Xaldin',
				...
				new BonusReward('Beast', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 25, 0, 0, 0, 0, 0))
		]
	}, {
		...
		bonusFights: [
			new BonusFight('Prison Keeper',
				...
				new BonusReward('Jack Skellington', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 15, 0, 0, 0, 0, 0)),
			...
			new BonusFight('Lock/Shock/Barrel',
				...
				new BonusReward('Jack Skellington', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 5, 0, 0, 0, 0, 0)),
			new BonusFight('The Experiment',
				...
				new BonusReward('Jack Skellington', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 10, 0, 0, 0, 0, 0)),
		...
		bonusFights: [
			new BonusFight('Village Cave Heartless',
				...
				new BonusReward('Ping/Mulan', 0x00000000, new Reward('Hyper Healing', 0x01A3), new Reward('EMPTY', 0x0000), 15, 0, 0, 0, 0, 0),
				null,
				null),
			new BonusFight('Shan-Yu',
				...
				new BonusReward('Ping/Mulan', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 20, 0, 0, 0, 0, 0)),
			new BonusFight('Storm Rider',
				...
				new BonusReward('Ping/Mulan', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 25, 0, 0, 0, 0, 0))
		]
	}, {
		...
		bonusFights: [
			new BonusFight('Cerberus',
				...
				new BonusReward('Auron', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 40, 0, 0, 0, 0, 0),
				null,
				null),
			...
			new BonusFight('Hades',
				...
				new BonusReward('Auron', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 15, 0, 0, 0, 0, 0)),
		...
		bonusFights: [
			...
			new BonusFight('The Interceptor Barrels',
				...
				new BonusReward('Jack Sparrow', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 10, 0, 0, 0, 0, 0)),
			new BonusFight('Captain Barbossa',
				...
				new BonusReward('Jack Sparrow', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 15, 0, 0, 0, 0, 0)),
		...
		bonusFights: [
			...
			new BonusFight('Scar',
				...
				new BonusReward('Simba', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 30, 0, 0, 0, 0, 0)),
			new BonusFight('Hyenas II',
				...
				new BonusReward('Simba', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 5, 0, 0, 0, 0, 0)),
		...
		bonusFights: [
			new BonusFight('Dataspace Computers',
				...
				new BonusReward('Tron', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 10, 0, 0, 0, 0, 0)),
			new BonusFight('Hostile Program',
				...
				new BonusReward('Tron', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 15, 0, 0, 0, 0, 0)),
			new BonusFight('Solar Sailor Heartless',
				...
				new BonusReward('Tron', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 5, 0, 0, 0, 0, 0)),
			new BonusFight('MCP',
		...
		bonusFights: [
			...
			new BonusFight('Final Xemnas',
				...
				new BonusReward('Riku', 0x00000000, new Reward('EMPTY', 0x0000), new Reward('EMPTY', 0x0000), 25, 0, 0, 0, 0, 0),
				null,
				null)
		]
	}
