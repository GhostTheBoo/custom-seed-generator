export class MagicAbility {
	constructor(name, address, cost, zipID) {
		this.ability = name
		...
		this.vanilla = () => {
			return new MagicAbility(this.ability, this.costAddress, this.vanillaCost, this.zipID)
		}
	...
	static saveToYml(magicData, isCommented) {
		return magicData.reduce((prev, magicType) => {
			magicType.abilities.forEach(ability => { prev += ability.saveToYml(isCommented) })
			return prev
		}, '')
	}
...
export const magicsData = [
	{
		...
		abilities: [
			new MagicAbility('Fire', 0x1CCBCE0, 12, 49),
			new MagicAbility('Fira', 0x1CCC8E0, 12, 119),
			new MagicAbility('Firaga', 0x1CCC910, 12, 120)
		]
	},
	{
		...
		abilities: [
			new MagicAbility('Blizzard', 0x1CCBD40, 15, 51),
			new MagicAbility('Blizzara', 0x1CCC940, 15, 121),
			new MagicAbility('Blizzaga', 0x1CCC970, 15, 122)
		]
	},
	{
		...
		abilities: [
			new MagicAbility('Thunder', 0x1CCBD10, 18, 50),
			new MagicAbility('Thundara', 0x1CCC9A0, 18, 123),
			new MagicAbility('Thundaga', 0x1CCC9D0, 18, 124)
		]
	},
	{
		...
		abilities: [
			new MagicAbility('Cure', 0x1CCBD70, 255, 52),
			new MagicAbility('Cura', 0x1CCCA00, 255, 125),
			new MagicAbility('Curaga', 0x1CCCA30, 255, 126)
		]
	},
	{
		...
		abilities: [
			new MagicAbility('Magnet', 0x1CCD240, 30, 174),
			new MagicAbility('Magnera', 0x1CCD270, 30, 175),
			new MagicAbility('Magnega', 0x1CCD2A0, 30, 176)
		]
	},
	{
		...
		abilities: [
			new MagicAbility('Reflect', 0x1CCD2D0, 10, 177),
			new MagicAbility('Reflera', 0x1CCD300, 10, 178),
			new MagicAbility('Reflega', 0x1CCD330, 10, 179)
		]
	},
	{
		magicType: 'Beast',
		pathName: 'equipmentImages/alw/1CDF406',
		abilities: [new MagicAbility('Twin Howl', 0x1CCC130, 255, 74)]
	},
	{
		magicType: 'Auron',
		pathName: 'equipmentImages/alw/1CDF3B6',
		abilities: [new MagicAbility('Bushido', 0x1CCC2B0, 255, 82)]
	},
	{
		magicType: 'Mulan',
		pathName: 'equipmentImages/alw/1CDF3C6',
		abilities: [new MagicAbility('Red Rocket', 0x1CCCC40, 255, 139)]
	},
	{
		magicType: 'Aladdin',
		pathName: 'equipmentImages/alw/1CDF3A6',
		abilities: [new MagicAbility('Speedster', 0x1CCF280, 255, 351)]
	},
	{
		magicType: 'Jack Sparrow',
		pathName: 'equipmentImages/alw/1CDF436',
		abilities: [new MagicAbility('Bluff', 0x1CCF3A0, 255, 357)]
	},
	{
		magicType: 'Simba',
		pathName: 'equipmentImages/alw/1CDF426',
		abilities: [new MagicAbility('Wildcat', 0x1CCF730, 255, 376)]
	},
	{
		magicType: 'Jack',
		pathName: 'equipmentImages/alw/1CDF416',
		abilities: [new MagicAbility('Dance Call', 0x1CCFCA0, 255, 405)]
	},
	{
		magicType: 'Tron',
		pathName: 'equipmentImages/alw/1CDF3E6',
		abilities: [new MagicAbility('Setup', 0x1CCFE80, 255, 415)]
	},
	{
		magicType: 'Riku',
		pathName: 'equipmentImages/alw/1CDF446',
		abilities: [new MagicAbility('Session', 0x1CD1AD0, 255, 569)]
	},
	{
		magicType: 'Sora',
		pathName: 'equipmentImages/key/key',
		abilities: [new MagicAbility('Trinity Limit', 0x1CD0B40, 255, 620)] // Maybe? 620 or 484 idk
	},
	{
		magicType: 'Goofy',
		pathName: 'equipmentImages/gsh/gsh',
		abilities: [
			new MagicAbility('Whirli-Goof', 0x1CCE110, 255, 255),
			new MagicAbility('Knocksmash', 0x1CCF040, 255, 338)
		]
	},
	{
		magicType: 'Donald',
		...
		abilities: [
			new MagicAbility('Comet', 0x1CCE620, 255, 282),
			new MagicAbility('Duck Flare', 0x1CCF160, 255, 344)
		]
	},
	{
		...
		abilities: [
			new MagicAbility('Strike Raid', 0x1CD3150, 65, 704),
			new MagicAbility('Sonic Blade', 0x1CD3030, 60, 698),
			new MagicAbility('Ragnarok', 0x1CD2F10, 80, 683),
			new MagicAbility('Ars Arcanum', 0x1CD30C0, 72, 701)
		]
	}
]